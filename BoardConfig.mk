...
# Assert
TARGET_OTA_ASSERT_DEVICE := jeter

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 17104896 # This is the maximum known partition size, but it can be higher, so we just omit it
